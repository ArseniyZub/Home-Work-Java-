...
public class Main {
    public static void main(String[] args) {
        ...
        Collections.sort(list, costComparator); // по увеличению 
        ...
        Collections.sort(list, reductionComparable); // по уменьшению 
        for (int i = 0; i < list.size(); i++) {
            System.out.println(list.get(i));
        }
        ...
        Collections.sort(list, fullSortingComparator); // по уменьшению ram и увелечению цены, если ram равны
        for (int i = 0; i < list.size(); i++) {
            System.out.println(list.get(i));
        }
    }
